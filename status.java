...
public class status extends JFrame {
	...
	public status(Pokemon pokemon) {
		LumBerry B1=new LumBerry();
		CobaBerry B2=new CobaBerry();
		WikiBerry B3=new WikiBerry();
		
		
		setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\User\\Desktop\\\u0E2B\u0E22\u0E07\u0E2B\u0E22\u0E07\\code\\Pokemon\\icon2.png"));
		...
		JButton btnsetname = new JButton("Edit");
		...
		btnsetname.setBounds(176, 28, 53, 24);
		...
		btnFeedBerry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				FeedBerry feed=new FeedBerry(pokemon,B1,B2,B3);	
			}
		});
